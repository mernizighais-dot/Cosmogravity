...
function trajectoire(compteur,mobile) {
  	...
  	if (mobile.debut) {
		...
		document.getElementById('ex1SCH4').disabled = true;
		document.getElementById('ex2SCH4').disabled = true;
		document.getElementById('ex3SCH4').disabled = true;
		...
		if (nomFichier !== null && nomFichier.trim() !== '') {
			...
			logo.onload = function() {
				...
				for (let i = 1; i <= nbFusees; i++) {
					...
					// 4. Calcul de l'espacement vertical (i-1) * 100 est une bonne idée
					let offset = (i - 1) * 110; // J'augmente un peu pour laisser de l'espace

					context3.fillText(ligne_mobile, x, y + 70 + offset);
					context3.fillText(ligne_r0, x, y + 90 + offset);
					context3.fillText(ligne_phi0, x, y + 110 + offset);
					context3.fillText(ligne_teta, x, y + 130 + offset);
